...
void put(char * filename)
{
	...
	//this part is probably not utilized at all
...
//as I go through the code one last time I believe that the data I get from this function is not actually used bc
//I base where I put my files in the dir_ptr from where in inode_array_ptr the valid attribute is 0
int findFreeDirEntry()
{
	int i;
	int retval = -1;
